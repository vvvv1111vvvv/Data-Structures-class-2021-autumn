...
2. 문제 : 실습 11.5: Kruskal의 최소비용 신장트리 알고리즘을 이용하여 최대비용 신장트리를 구하는
                    프로그램을 구현
3. 방법 : 11.3절의 함수와 테스트 코드를 응용한다.

#최대비용신장트리 (MaxST): 1. 그래프의 모든정점들은 연결한다.
                        2. 가중치 합이 최대
                        3. 사이클 없이 N-1개의 간선
...
#2. Kruskal의 최대신장트리 알고리즘함수 MaxSTKruskal()를 호출한다.
    ...
    #2-5. 간선의 개수가 정점의 개수보다 1 작을 동안 반복
        #2-5-1.  가중치가 가장 큰 간선의 두 정점이 속한 집합을 비교한다. find()호출
