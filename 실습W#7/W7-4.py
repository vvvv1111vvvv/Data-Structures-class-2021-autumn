...
2. 문제 : 7.3절의 합집합 코드를 참조하여 정렬된 리스트를 사용해 효율적인 차집합 함수를 구현
    ...
    def difference(self,setB):
        ...
        while a<len(self.item) and b<len(setB.item):
            ...
            if ValueA<ValueB:
                ...
                a+=1
                b+=1
        while a<len(self.item):
            newset.item.append(self.item[a])
            a+=1
        return newset
#1. 집합클래스의 객체 s와 t를 선언한다.
